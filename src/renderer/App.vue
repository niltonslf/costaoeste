<template>
  <div id="app">
    <nav class="navbar navbar-dark fixed-top bg-panel flex-md-nowrap p-0 shadow">
      <a class="navbar-brand col-sm-3 col-md-2 mr-0" href="#">Costa Oeste</a>
...
<script>
import { DollarSignIcon,HomeIcon } from 'vue-feather-icons'
